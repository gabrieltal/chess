...
export default class King extends Piece {
  ...
  possibleMoves(squares, currentPosition) {
    ...
    if (possibleMove > 0 && !this.teamPieceAtSquare(squares, possibleMove)) {
    ...
    if (currentPosition % 8 !== 0 && !this.teamPieceAtSquare(squares, possibleMove)) {
      possibilities.push(possibleMove);
    }

    // Check right move
    possibleMove = currentPosition + 1;
    if (possibleMove % 8 !== 0 && !this.teamPieceAtSquare(squares, possibleMove)) {
      possibilities.push(possibleMove);
    }

    // Check down move
    possibleMove = currentPosition + 8;
    if (possibleMove < 64 && !this.teamPieceAtSquare(squares, possibleMove)) {
      possibilities.push(possibleMove);
    }
